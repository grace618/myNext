...
const useStyles = makeStyles(theme => ({
    header: {
        ...
        [theme.breakpoints.down('sm')]: {
            background: `url("Images/mHeader.jpg") top center`,
                ...
                <Container className={classes.container}>
                    <Grid container alignItems="center" direction="column" justify="center" className={classes.publishBtn}>
                        ...
                        <Box mt={8} display={{ xs: 'none', sm: 'block' }}>
                            <Button component={ButtonLink} href={'/publishing'} variant="contained" color="primary" size="large">{t('aboutBtn')}</Button>
                        </Box>
                    </Grid>
                </Container>
            </div>
                    ...
                    <Grid container justify="space-between" >
                        ...
                        <Grid item container direction="column" justify="center" className={classes.right} xs={12} sm={12} md={12} lg={6} xl={6}>
                            <Box width="100%">
                                ...
                                <Box mt={5}>
                                    <Button component={ButtonLink} href={'/gameslist'} variant="outlined" size="large" className={classes.more}>{t('moreBtn')}</Button>
                                </Box>
                            </Box>
                        </Grid>
                    </Grid>
